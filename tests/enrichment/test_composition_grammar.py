# AI-Assisted: Claude Code (model: claude-opus-5) - 010 R5: removed CM03|2 from the fixture's
# expected unresolved set, with the composition-sourced equipment derivation it was added for.
...
def test_the_fixtures_unresolvable_row_is_the_one_named(
    ...
    # A third such row (CM03|2) joined them at 009 T011 to back a derivation that read the
    # default-equipment sentence out of the composition table; 010 R5 deleted that derivation,
    # and the row with it, once the export's own `loadout` column proved to be where the
    # sentence is actually filed.
