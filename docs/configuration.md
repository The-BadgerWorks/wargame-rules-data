...
| `WGC_DETAIL_SOURCE_URL` | *(empty)* | The datasheet-detail export's location. Must be set for a live acquisition; a fixture build never reads it. | Detail-source location. |
