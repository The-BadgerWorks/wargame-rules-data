# Validation report — wh40k-11e-2026-08

**ADVISORY ONLY** — eligible for publication pending approval.

Run `local-wh40k-11e-2026-08` on the `prerelease` channel, 2026-08-07T00:00:00Z.
...
| keyword classification | 1449 | 98.8% |
| summaries outstanding | 0 | 0.0% |
| unlinked choices | 1485 | 71.3% |
| unparsed option rows | 689 | 33.1% |
| unverified pricing | 647 | 31.1% |
| wargear options resolved | 1676 | 80.4% |
...
|---|---|---|---|---|
| composition | 2064 | 0 | 100.0% | 90.0% |
| datasheets | 2084 | 2099 | 99.3% | 90.0% |
| factions | 30 | 30 | 100.0% | 95.0% |
| keyword classification | 1449 | 0 | 100.0% | 95.0% |
| priced datasheets | 2084 | 2099 | 99.3% | 90.0% |
| summaries.abilities | 1941 | 0 | 100.0% | 0.0% |
| summaries.detachment rules | 324 | 0 | 100.0% | 0.0% |
| summaries.faction rules | 28 | 0 | 100.0% | 0.0% |
| summaries.glossary | 70 | 0 | 5.0% | 0.0% |
| wargear options | 1676 | 0 | 100.0% | 90.0% |
...
0 blocking, 5820 advisory, 5 suppressed.
...
<details><summary>data_quality (793)</summary>
...
| `OPT-UNPARSED` | advisory | `ds-achilles-ridgerunners` | — |
| `OPT-UNPARSED` | advisory | `ds-achilles-ridgerunners` | — |
| `OPT-UNPARSED` | advisory | `ds-acolyte-hybrids-with-autopistols` | — |
| `OPT-UNPARSED` | advisory | `ds-acolyte-hybrids-with-autopistols` | — |
| `OPT-UNPARSED` | advisory | `ds-acolyte-hybrids-with-hand-flamers` | — |
| `OPT-UNPARSED` | advisory | `ds-acolyte-hybrids-with-hand-flamers` | — |
| `OPT-UNPARSED` | advisory | `ds-agamatus-custodians` | — |
| `OPT-UNPARSED` | advisory | `ds-aggressor-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-aggressor-squad-2` | — |
| `OPT-UNPARSED` | advisory | `ds-aggressor-squad-3` | — |
| `OPT-UNPARSED` | advisory | `ds-aggressor-squad-4` | — |
| `OPT-UNPARSED` | advisory | `ds-aggressor-squad-5` | — |
| `OPT-UNPARSED` | advisory | `ds-aggressor-squad-6` | — |
| `OPT-UNPARSED` | advisory | `ds-allarus-custodians` | — |
| `OPT-UNPARSED` | advisory | `ds-aquilon-custodians` | — |
| `OPT-UNPARSED` | advisory | `ds-aquilon-custodians` | — |
...
| `OPT-UNPARSED` | advisory | `ds-assault-squad-with-jump-packs` | — |
| `OPT-UNPARSED` | advisory | `ds-astartes-servitors` | — |
| `OPT-UNPARSED` | advisory | `ds-atalan-jackals` | — |
| `OPT-UNPARSED` | advisory | `ds-atalan-jackals` | — |
| `OPT-UNPARSED` | advisory | `ds-atalan-jackals` | — |
| `OPT-UNPARSED` | advisory | `ds-attack-bike-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-big-gunz` | — |
| `OPT-UNPARSED` | advisory | `ds-bike-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-bike-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-bike-squad` | — |
...
| `OPT-UNPARSED` | advisory | `ds-boyz` | — |
| `OPT-UNPARSED` | advisory | `ds-boyz` | — |
| `OPT-UNPARSED` | advisory | `ds-breaka-boyz` | — |
| `OPT-UNPARSED` | advisory | `ds-breaka-boyz` | — |
| `OPT-UNPARSED` | advisory | `ds-broadside-battlesuits` | — |
| `OPT-UNPARSED` | advisory | `ds-broadside-battlesuits` | — |
| `OPT-UNPARSED` | advisory | `ds-broadside-battlesuits` | — |
| `OPT-UNPARSED` | advisory | `ds-brokhyr-thunderkyn` | — |
| `OPT-UNPARSED` | advisory | `ds-brokhyr-thunderkyn` | — |
| `OPT-UNPARSED` | advisory | `ds-brotherhood-terminator-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-bullgryn-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-bullgryn-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-burna-boyz` | — |
| `OPT-UNPARSED` | advisory | `ds-cadian-heavy-weapons-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-cadian-heavy-weapons-squad-2` | — |
| `OPT-UNPARSED` | advisory | `ds-cadian-recon-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-cadian-recon-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-cadian-recon-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-cadian-recon-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-cadian-recon-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-cadian-shock-troops` | — |
| `OPT-UNPARSED` | advisory | `ds-cadian-shock-troops` | — |
| `OPT-UNPARSED` | advisory | `ds-cadian-shock-troops` | — |
| `OPT-UNPARSED` | advisory | `ds-cadian-shock-troops-2` | — |
| `OPT-UNPARSED` | advisory | `ds-cadian-shock-troops-2` | — |
| `OPT-UNPARSED` | advisory | `ds-cadian-shock-troops-2` | — |
| `OPT-UNPARSED` | advisory | `ds-canoness` | — |
| `OPT-UNPARSED` | advisory | `ds-canoness` | — |
| `OPT-UNPARSED` | advisory | `ds-canoptek-macrocytes` | — |
...
| `OPT-UNPARSED` | advisory | `ds-catachan-command-squad-2` | — |
| `OPT-UNPARSED` | advisory | `ds-catachan-command-squad-2` | — |
| `OPT-UNPARSED` | advisory | `ds-catachan-heavy-weapons-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-catachan-heavy-weapons-squad-2` | — |
| `OPT-UNPARSED` | advisory | `ds-celestian-insidiants` | — |
| `OPT-UNPARSED` | advisory | `ds-celestian-insidiants` | — |
| `OPT-UNPARSED` | advisory | `ds-celestian-insidiants` | — |
| `OPT-UNPARSED` | advisory | `ds-celestian-insidiants` | — |
| `OPT-UNPARSED` | advisory | `ds-celestian-insidiants` | — |
| `OPT-UNPARSED` | advisory | `ds-celestian-sacresants` | — |
| `OPT-UNPARSED` | advisory | `ds-centaur-rsv` | — |
| `OPT-UNPARSED` | advisory | `ds-centaur-rsv-2` | — |
| `OPT-UNPARSED` | advisory | `ds-centurion-assault-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-centurion-assault-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-centurion-assault-squad-2` | — |
| `OPT-UNPARSED` | advisory | `ds-centurion-assault-squad-2` | — |
| `OPT-UNPARSED` | advisory | `ds-centurion-assault-squad-3` | — |
| `OPT-UNPARSED` | advisory | `ds-centurion-assault-squad-3` | — |
| `OPT-UNPARSED` | advisory | `ds-centurion-assault-squad-4` | — |
| `OPT-UNPARSED` | advisory | `ds-centurion-assault-squad-4` | — |
| `OPT-UNPARSED` | advisory | `ds-centurion-assault-squad-5` | — |
| `OPT-UNPARSED` | advisory | `ds-centurion-assault-squad-5` | — |
| `OPT-UNPARSED` | advisory | `ds-centurion-assault-squad-6` | — |
| `OPT-UNPARSED` | advisory | `ds-centurion-assault-squad-6` | — |
| `OPT-UNPARSED` | advisory | `ds-centurion-devastator-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-centurion-devastator-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-centurion-devastator-squad-2` | — |
| `OPT-UNPARSED` | advisory | `ds-centurion-devastator-squad-2` | — |
| `OPT-UNPARSED` | advisory | `ds-centurion-devastator-squad-3` | — |
| `OPT-UNPARSED` | advisory | `ds-centurion-devastator-squad-3` | — |
| `OPT-UNPARSED` | advisory | `ds-centurion-devastator-squad-4` | — |
| `OPT-UNPARSED` | advisory | `ds-centurion-devastator-squad-4` | — |
| `OPT-UNPARSED` | advisory | `ds-centurion-devastator-squad-5` | — |
| `OPT-UNPARSED` | advisory | `ds-centurion-devastator-squad-5` | — |
| `OPT-UNPARSED` | advisory | `ds-centurion-devastator-squad-6` | — |
| `OPT-UNPARSED` | advisory | `ds-centurion-devastator-squad-6` | — |
| `OPT-UNPARSED` | advisory | `ds-chaos-acastus-knight-porphyrion` | — |
| `OPT-UNPARSED` | advisory | `ds-chaos-bikers` | — |
| `OPT-UNPARSED` | advisory | `ds-chaos-bikers` | — |
| `OPT-UNPARSED` | advisory | `ds-chaos-terminator-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-chaos-terminator-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-chaos-terminator-squad-2` | — |
| `OPT-UNPARSED` | advisory | `ds-chaos-terminator-squad-2` | — |
| `OPT-UNPARSED` | advisory | `ds-chaos-terminators` | — |
| `OPT-UNPARSED` | advisory | `ds-chaos-terminators` | — |
| `OPT-UNPARSED` | advisory | `ds-chaos-terminators-2` | — |
| `OPT-UNPARSED` | advisory | `ds-chaos-terminators-2` | — |
...
| `OPT-UNPARSED` | advisory | `ds-chosen-2` | — |
| `OPT-UNPARSED` | advisory | `ds-chosen-2` | — |
| `OPT-UNPARSED` | advisory | `ds-command-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-command-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-command-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-command-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-commissar-graves` | — |
| `OPT-UNPARSED` | advisory | `ds-commissar-graves-on-foot` | — |
| `OPT-UNPARSED` | advisory | `ds-company-veterans-on-bikes` | — |
| `OPT-UNPARSED` | advisory | `ds-company-veterans-on-bikes` | — |
| `OPT-UNPARSED` | advisory | `ds-corsair-cloud-dancer-band` | — |
| `OPT-UNPARSED` | advisory | `ds-corsair-cloud-dancer-band-2` | — |
| `OPT-UNPARSED` | advisory | `ds-corsair-reaver-band` | — |
| `OPT-UNPARSED` | advisory | `ds-corsair-reaver-band-2` | — |
...
| `OPT-UNPARSED` | advisory | `ds-crisis-battlesuits` | — |
| `OPT-UNPARSED` | advisory | `ds-crisis-fireknife-battlesuits` | — |
| `OPT-UNPARSED` | advisory | `ds-crisis-fireknife-battlesuits` | — |
| `OPT-UNPARSED` | advisory | `ds-crisis-starscythe-battlesuits` | — |
| `OPT-UNPARSED` | advisory | `ds-crisis-starscythe-battlesuits` | — |
| `OPT-UNPARSED` | advisory | `ds-cronos` | — |
| `OPT-UNPARSED` | advisory | `ds-crusader-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-crusader-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-crusader-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-cthonian-beserks` | — |
| `OPT-UNPARSED` | advisory | `ds-cthonian-beserks` | — |
| `OPT-UNPARSED` | advisory | `ds-cthonian-earthshakers` | — |
| `OPT-UNPARSED` | advisory | `ds-cultist-mob-with-firearms` | — |
| `OPT-UNPARSED` | advisory | `ds-cultist-mob-with-firearms-2` | — |
| `OPT-UNPARSED` | advisory | `ds-cultist-mob-with-firearms-3` | — |
| `OPT-UNPARSED` | advisory | `ds-custodian-guard` | — |
| `OPT-UNPARSED` | advisory | `ds-custodian-guard-with-adrasite-and-pyrithite-spears` | — |
| `OPT-UNPARSED` | advisory | `ds-custodian-wardens` | — |
| `OPT-UNPARSED` | advisory | `ds-damned-legionnaires` | — |
| `OPT-UNPARSED` | advisory | `ds-damned-legionnaires` | — |
| `OPT-UNPARSED` | advisory | `ds-dark-reapers` | — |
| `OPT-UNPARSED` | advisory | `ds-death-company-marines-with-boltguns` | — |
| `OPT-UNPARSED` | advisory | `ds-death-company-marines-with-boltguns` | — |
| `OPT-UNPARSED` | advisory | `ds-death-company-marines-with-boltguns` | — |
| `OPT-UNPARSED` | advisory | `ds-death-company-marines-with-boltguns-and-jump-packs` | — |
| `OPT-UNPARSED` | advisory | `ds-death-company-marines-with-boltguns-and-jump-packs` | — |
| `OPT-UNPARSED` | advisory | `ds-death-company-marines-with-boltguns-and-jump-packs` | — |
| `OPT-UNPARSED` | advisory | `ds-death-korps-grenadier-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-death-korps-grenadier-squad-2` | — |
...
| `OPT-UNPARSED` | advisory | `ds-deathwatch-kill-team` | — |
| `OPT-UNPARSED` | advisory | `ds-deathwatch-kill-team` | — |
| `OPT-UNPARSED` | advisory | `ds-deathwatch-terminator-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-deathwatch-terminator-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-deathwatch-terminator-squad-2` | — |
| `OPT-UNPARSED` | advisory | `ds-deathwatch-terminator-squad-2` | — |
...
| `OPT-UNPARSED` | advisory | `ds-deathwing-terminator-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-deathwing-terminator-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-decimator` | — |
| `OPT-UNPARSED` | advisory | `ds-decimator` | — |
| `OPT-UNPARSED` | advisory | `ds-deff-dread` | — |
| `OPT-UNPARSED` | advisory | `ds-deff-dread` | — |
| `OPT-UNPARSED` | advisory | `ds-deff-rolla-battle-fortress` | — |
| `OPT-UNPARSED` | advisory | `ds-deff-rolla-battle-fortress` | — |
...
| `OPT-UNPARSED` | advisory | `ds-devastator-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-devastator-squad-2` | — |
| `OPT-UNPARSED` | advisory | `ds-devastator-squad-3` | — |
| `OPT-UNPARSED` | advisory | `ds-devastator-squad-4` | — |
| `OPT-UNPARSED` | advisory | `ds-dire-avengers` | — |
| `OPT-UNPARSED` | advisory | `ds-dire-avengers` | — |
| `OPT-UNPARSED` | advisory | `ds-dominion-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-einhyr-hearthguard` | — |
| `OPT-UNPARSED` | advisory | `ds-einhyr-hearthguard` | — |
...
| `OPT-UNPARSED` | advisory | `ds-exaction-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-execrator` | — |
| `OPT-UNPARSED` | advisory | `ds-field-ordnance-battery` | — |
| `OPT-UNPARSED` | advisory | `ds-field-ordnance-battery-2` | — |
| `OPT-UNPARSED` | advisory | `ds-fire-dragons` | — |
| `OPT-UNPARSED` | advisory | `ds-firestrike-servo-turrets` | — |
| `OPT-UNPARSED` | advisory | `ds-firestrike-servo-turrets-2` | — |
| `OPT-UNPARSED` | advisory | `ds-firestrike-servo-turrets-3` | — |
| `OPT-UNPARSED` | advisory | `ds-firestrike-servo-turrets-4` | — |
| `OPT-UNPARSED` | advisory | `ds-firestrike-servo-turrets-5` | — |
| `OPT-UNPARSED` | advisory | `ds-firestrike-servo-turrets-6` | — |
| `OPT-UNPARSED` | advisory | `ds-flash-gitz` | — |
...
| `OPT-UNPARSED` | advisory | `ds-havocs` | — |
| `OPT-UNPARSED` | advisory | `ds-havocs-2` | — |
| `OPT-UNPARSED` | advisory | `ds-hearthkyn-warriors` | — |
| `OPT-UNPARSED` | advisory | `ds-hearthkyn-warriors` | — |
| `OPT-UNPARSED` | advisory | `ds-hearthkyn-warriors` | — |
| `OPT-UNPARSED` | advisory | `ds-heavy-gun-drones` | — |
...
| `OPT-UNPARSED` | advisory | `ds-hernkyn-yaegirs` | — |
| `OPT-UNPARSED` | advisory | `ds-hernkyn-yaegirs` | — |
| `OPT-UNPARSED` | advisory | `ds-hippogriff-afv` | — |
| `OPT-UNPARSED` | advisory | `ds-hippogriff-afv` | — |
| `OPT-UNPARSED` | advisory | `ds-hippogriff-afv-2` | — |
| `OPT-UNPARSED` | advisory | `ds-hippogriff-afv-2` | — |
| `OPT-UNPARSED` | advisory | `ds-hive-guard` | — |
| `OPT-UNPARSED` | advisory | `ds-hornet` | — |
| `OPT-UNPARSED` | advisory | `ds-howling-banshees` | — |
| `OPT-UNPARSED` | advisory | `ds-hybrid-metamorphs` | — |
| `OPT-UNPARSED` | advisory | `ds-hybrid-metamorphs` | — |
| `OPT-UNPARSED` | advisory | `ds-immortals` | — |
| `OPT-UNPARSED` | advisory | `ds-inceptor-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-inceptor-squad-2` | — |
| `OPT-UNPARSED` | advisory | `ds-inceptor-squad-3` | — |
| `OPT-UNPARSED` | advisory | `ds-inceptor-squad-4` | — |
| `OPT-UNPARSED` | advisory | `ds-inceptor-squad-5` | — |
| `OPT-UNPARSED` | advisory | `ds-inceptor-squad-6` | — |
| `OPT-UNPARSED` | advisory | `ds-incursor-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-incursor-squad-2` | — |
| `OPT-UNPARSED` | advisory | `ds-incursor-squad-3` | — |
| `OPT-UNPARSED` | advisory | `ds-incursor-squad-4` | — |
| `OPT-UNPARSED` | advisory | `ds-incursor-squad-5` | — |
| `OPT-UNPARSED` | advisory | `ds-incursor-squad-6` | — |
...
| `OPT-UNPARSED` | advisory | `ds-inquisitor-in-terminator-armour` | — |
| `OPT-UNPARSED` | advisory | `ds-inquisitorial-agents` | — |
| `OPT-UNPARSED` | advisory | `ds-inquisitorial-agents` | — |
| `OPT-UNPARSED` | advisory | `ds-inquisitorial-agents` | — |
| `OPT-UNPARSED` | advisory | `ds-inquisitorial-agents` | — |
| `OPT-UNPARSED` | advisory | `ds-inquisitorial-agents` | — |
| `OPT-UNPARSED` | advisory | `ds-ironkin-steeljacks-with-melee-weapons` | — |
| `OPT-UNPARSED` | advisory | `ds-ironstrider-ballistarii` | — |
| `OPT-UNPARSED` | advisory | `ds-jakhals` | — |
| `OPT-UNPARSED` | advisory | `ds-kapricus-defenders` | — |
| `OPT-UNPARSED` | advisory | `ds-kapricus-defenders` | — |
| `OPT-UNPARSED` | advisory | `ds-kasrkin` | — |
| `OPT-UNPARSED` | advisory | `ds-kasrkin-2` | — |
| `OPT-UNPARSED` | advisory | `ds-kastelan-robots` | — |
| `OPT-UNPARSED` | advisory | `ds-kastelan-robots` | — |
| `OPT-UNPARSED` | advisory | `ds-kataphron-breachers` | — |
| `OPT-UNPARSED` | advisory | `ds-kataphron-breachers` | — |
| `OPT-UNPARSED` | advisory | `ds-kataphron-destroyers` | — |
| `OPT-UNPARSED` | advisory | `ds-kataphron-destroyers` | — |
| `OPT-UNPARSED` | advisory | `ds-kill-team-cassius` | — |
| `OPT-UNPARSED` | advisory | `ds-kill-team-cassius` | — |
| `OPT-UNPARSED` | advisory | `ds-kill-team-cassius` | — |
| `OPT-UNPARSED` | advisory | `ds-kill-team-cassius` | — |
| `OPT-UNPARSED` | advisory | `ds-kill-team-cassius` | — |
...
| `OPT-UNPARSED` | advisory | `ds-kill-team-cassius` | — |
| `OPT-UNPARSED` | advisory | `ds-kill-team-cassius` | — |
| `OPT-UNPARSED` | advisory | `ds-kill-team-cassius-2` | — |
| `OPT-UNPARSED` | advisory | `ds-kill-team-cassius-2` | — |
| `OPT-UNPARSED` | advisory | `ds-kill-team-cassius-2` | — |
| `OPT-UNPARSED` | advisory | `ds-kill-team-cassius-2` | — |
| `OPT-UNPARSED` | advisory | `ds-kill-team-cassius-2` | — |
...
| `OPT-UNPARSED` | advisory | `ds-kill-team-cassius-2` | — |
| `OPT-UNPARSED` | advisory | `ds-kill-team-cassius-2` | — |
| `OPT-UNPARSED` | advisory | `ds-killa-kans` | — |
| `OPT-UNPARSED` | advisory | `ds-kommandos` | — |
| `OPT-UNPARSED` | advisory | `ds-kommandos` | — |
| `OPT-UNPARSED` | advisory | `ds-kommandos` | — |
| `OPT-UNPARSED` | advisory | `ds-krieg-combat-engineers` | — |
| `OPT-UNPARSED` | advisory | `ds-krieg-combat-engineers-2` | — |
| `OPT-UNPARSED` | advisory | `ds-krieg-command-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-krieg-command-squad-2` | — |
| `OPT-UNPARSED` | advisory | `ds-krieg-heavy-weapons-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-krieg-heavy-weapons-squad-2` | — |
| `OPT-UNPARSED` | advisory | `ds-krootox-riders` | — |
...
| `OPT-UNPARSED` | advisory | `ds-legionaries` | — |
| `OPT-UNPARSED` | advisory | `ds-legionaries` | — |
| `OPT-UNPARSED` | advisory | `ds-legionaries` | — |
| `OPT-UNPARSED` | advisory | `ds-legionaries-2` | — |
| `OPT-UNPARSED` | advisory | `ds-legionaries-2` | — |
| `OPT-UNPARSED` | advisory | `ds-legionaries-2` | — |
| `OPT-UNPARSED` | advisory | `ds-leviathan-dreadnought` | — |
| `OPT-UNPARSED` | advisory | `ds-leviathan-dreadnought-2` | — |
| `OPT-UNPARSED` | advisory | `ds-leviathan-dreadnought-3` | — |
| `OPT-UNPARSED` | advisory | `ds-leviathan-dreadnought-4` | — |
| `OPT-UNPARSED` | advisory | `ds-leviathan-dreadnought-5` | — |
| `OPT-UNPARSED` | advisory | `ds-lokhust-heavy-destroyers` | — |
| `OPT-UNPARSED` | advisory | `ds-long-fangs` | — |
| `OPT-UNPARSED` | advisory | `ds-long-fangs` | — |
| `OPT-UNPARSED` | advisory | `ds-lootas` | — |
| `OPT-UNPARSED` | advisory | `ds-lychguard` | — |
| `OPT-UNPARSED` | advisory | `ds-meganobz` | — |
| `OPT-UNPARSED` | advisory | `ds-mek-gunz` | — |
| `OPT-UNPARSED` | advisory | `ds-militarum-tempestus-command-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-mortifiers` | — |
| `OPT-UNPARSED` | advisory | `ds-mortifiers` | — |
| `OPT-UNPARSED` | advisory | `ds-mukaali-riders` | — |
| `OPT-UNPARSED` | advisory | `ds-mukaali-riders-2` | — |
| `OPT-UNPARSED` | advisory | `ds-munitorum-servitors` | — |
| `OPT-UNPARSED` | advisory | `ds-munitorum-servitors-2` | — |
| `OPT-UNPARSED` | advisory | `ds-necron-warriors` | — |
...
| `OPT-UNPARSED` | advisory | `ds-outrider-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-outrider-squad-2` | — |
| `OPT-UNPARSED` | advisory | `ds-outrider-squad-3` | — |
| `OPT-UNPARSED` | advisory | `ds-outrider-squad-4` | — |
| `OPT-UNPARSED` | advisory | `ds-outrider-squad-5` | — |
| `OPT-UNPARSED` | advisory | `ds-outrider-squad-6` | — |
| `OPT-UNPARSED` | advisory | `ds-overlord` | — |
| `OPT-UNPARSED` | advisory | `ds-paladin-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-paladin-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-paragon-warsuits` | — |
| `OPT-UNPARSED` | advisory | `ds-paragon-warsuits` | — |
| `OPT-UNPARSED` | advisory | `ds-paragon-warsuits` | — |
| `OPT-UNPARSED` | advisory | `ds-pathfinder-team` | — |
| `OPT-UNPARSED` | advisory | `ds-penitent-engines` | — |
...
| `OPT-UNPARSED` | advisory | `ds-proteus-kill-team` | — |
| `OPT-UNPARSED` | advisory | `ds-proteus-kill-team` | — |
| `OPT-UNPARSED` | advisory | `ds-purgation-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-purifier-squad` | — |
...
| `OPT-UNPARSED` | advisory | `ds-reiver-squad-6` | — |
| `OPT-UNPARSED` | advisory | `ds-reiver-squad-6` | — |
| `OPT-UNPARSED` | advisory | `ds-relic-contemptor-dreadnought` | — |
| `OPT-UNPARSED` | advisory | `ds-relic-contemptor-dreadnought` | — |
| `OPT-UNPARSED` | advisory | `ds-relic-contemptor-dreadnought-2` | — |
| `OPT-UNPARSED` | advisory | `ds-relic-contemptor-dreadnought-2` | — |
| `OPT-UNPARSED` | advisory | `ds-relic-contemptor-dreadnought-3` | — |
| `OPT-UNPARSED` | advisory | `ds-relic-contemptor-dreadnought-3` | — |
| `OPT-UNPARSED` | advisory | `ds-relic-contemptor-dreadnought-4` | — |
| `OPT-UNPARSED` | advisory | `ds-relic-contemptor-dreadnought-4` | — |
| `OPT-UNPARSED` | advisory | `ds-relic-contemptor-dreadnought-5` | — |
| `OPT-UNPARSED` | advisory | `ds-relic-contemptor-dreadnought-5` | — |
| `OPT-UNPARSED` | advisory | `ds-relic-terminator-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-relic-terminator-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-relic-terminator-squad` | — |
...
| `OPT-UNPARSED` | advisory | `ds-renegade-ogryn-brutes` | — |
| `OPT-UNPARSED` | advisory | `ds-renegade-ogryn-brutes-2` | — |
| `OPT-UNPARSED` | advisory | `ds-renegade-ogryn-brutes-3` | — |
| `OPT-UNPARSED` | advisory | `ds-retributor-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-ripper-swarms` | — |
| `OPT-UNPARSED` | advisory | `ds-rubric-marines` | — |
| `OPT-UNPARSED` | advisory | `ds-rubric-marines-2` | — |
...
| `OPT-UNPARSED` | advisory | `ds-sanctifiers-2` | — |
| `OPT-UNPARSED` | advisory | `ds-sanctifiers-2` | — |
| `OPT-UNPARSED` | advisory | `ds-sanguinary-guard` | — |
| `OPT-UNPARSED` | advisory | `ds-sanguinary-guard` | — |
| `OPT-UNPARSED` | advisory | `ds-scourges-with-heavy-weapons` | — |
| `OPT-UNPARSED` | advisory | `ds-scout-bike-squad` | — |
...
| `OPT-UNPARSED` | advisory | `ds-scout-sentinels-2` | — |
| `OPT-UNPARSED` | advisory | `ds-scout-sentinels-2` | — |
| `OPT-UNPARSED` | advisory | `ds-scout-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-scout-squad-2` | — |
| `OPT-UNPARSED` | advisory | `ds-scout-squad-3` | — |
| `OPT-UNPARSED` | advisory | `ds-scout-squad-4` | — |
| `OPT-UNPARSED` | advisory | `ds-scout-squad-5` | — |
| `OPT-UNPARSED` | advisory | `ds-sekhetar-robots` | — |
| `OPT-UNPARSED` | advisory | `ds-seraphim-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-servitor-battleclade` | — |
| `OPT-UNPARSED` | advisory | `ds-servitor-battleclade` | — |
| `OPT-UNPARSED` | advisory | `ds-servitors` | — |
| `OPT-UNPARSED` | advisory | `ds-sicarian-infiltrators` | — |
| `OPT-UNPARSED` | advisory | `ds-sicarian-ruststalkers` | — |
| `OPT-UNPARSED` | advisory | `ds-sisters-novitiate-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-sisters-novitiate-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-skorpekh-destroyers` | — |
| `OPT-UNPARSED` | advisory | `ds-sky-slasher-swarms` | — |
| `OPT-UNPARSED` | advisory | `ds-skyclaws` | — |
| `OPT-UNPARSED` | advisory | `ds-skyweavers` | — |
| `OPT-UNPARSED` | advisory | `ds-skyweavers` | — |
| `OPT-UNPARSED` | advisory | `ds-skyweavers-2` | — |
| `OPT-UNPARSED` | advisory | `ds-skyweavers-2` | — |
...
| `OPT-UNPARSED` | advisory | `ds-spectrus-kill-team-2` | — |
| `OPT-UNPARSED` | advisory | `ds-spectrus-kill-team-2` | — |
| `OPT-UNPARSED` | advisory | `ds-stealth-battlesuits` | — |
| `OPT-UNPARSED` | advisory | `ds-sternguard-veteran-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-sternguard-veteran-squad-2` | — |
| `OPT-UNPARSED` | advisory | `ds-sternguard-veteran-squad-3` | — |
| `OPT-UNPARSED` | advisory | `ds-sternguard-veteran-squad-4` | — |
| `OPT-UNPARSED` | advisory | `ds-sternguard-veteran-squad-5` | — |
| `OPT-UNPARSED` | advisory | `ds-sternguard-veteran-squad-6` | — |
| `OPT-UNPARSED` | advisory | `ds-storm-guardians` | — |
| `OPT-UNPARSED` | advisory | `ds-storm-guardians` | — |
| `OPT-UNPARSED` | advisory | `ds-storm-guardians` | — |
| `OPT-UNPARSED` | advisory | `ds-stormwolf` | — |
| `OPT-UNPARSED` | advisory | `ds-strike-team` | — |
| `OPT-UNPARSED` | advisory | `ds-striking-scorpions` | — |
| `OPT-UNPARSED` | advisory | `ds-swooping-hawks` | — |
| `OPT-UNPARSED` | advisory | `ds-sword-brethren-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-sword-brethren-squad` | — |
...
| `OPT-UNPARSED` | advisory | `ds-talos` | — |
| `OPT-UNPARSED` | advisory | `ds-talos` | — |
| `OPT-UNPARSED` | advisory | `ds-tankbustas` | — |
| `OPT-UNPARSED` | advisory | `ds-tarantula-battery` | — |
| `OPT-UNPARSED` | advisory | `ds-tarantula-battery-2` | — |
...
| `OPT-UNPARSED` | advisory | `ds-tempestus-aquilons` | — |
| `OPT-UNPARSED` | advisory | `ds-tempestus-aquilons` | — |
| `OPT-UNPARSED` | advisory | `ds-tempestus-scions` | — |
| `OPT-UNPARSED` | advisory | `ds-termagants` | — |
| `OPT-UNPARSED` | advisory | `ds-termagants` | — |
| `OPT-UNPARSED` | advisory | `ds-terminator-assault-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-terminator-assault-squad-2` | — |
| `OPT-UNPARSED` | advisory | `ds-terminator-assault-squad-3` | — |
| `OPT-UNPARSED` | advisory | `ds-terminator-assault-squad-4` | — |
| `OPT-UNPARSED` | advisory | `ds-terminator-assault-squad-5` | — |
| `OPT-UNPARSED` | advisory | `ds-terminator-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-terminator-squad-2` | — |
| `OPT-UNPARSED` | advisory | `ds-terminator-squad-3` | — |
| `OPT-UNPARSED` | advisory | `ds-terminator-squad-4` | — |
| `OPT-UNPARSED` | advisory | `ds-terminator-squad-5` | — |
| `OPT-UNPARSED` | advisory | `ds-the-red-terror` | — |
| `OPT-UNPARSED` | advisory | `ds-the-red-terror-2` | — |
| `OPT-UNPARSED` | advisory | `ds-the-twin-lance` | — |
| `OPT-UNPARSED` | advisory | `ds-thunderwolf-cavalry` | — |
| `OPT-UNPARSED` | advisory | `ds-tomb-blades` | — |
| `OPT-UNPARSED` | advisory | `ds-tomb-blades` | — |
| `OPT-UNPARSED` | advisory | `ds-tomb-blades` | — |
| `OPT-UNPARSED` | advisory | `ds-tomb-citadel-walls` | — |
| `OPT-UNPARSED` | advisory | `ds-traitor-guardsmen-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-traitor-guardsmen-squad-2` | — |
| `OPT-UNPARSED` | advisory | `ds-traitor-guardsmen-squad-3` | — |
| `OPT-UNPARSED` | advisory | `ds-triarch-praetorians` | — |
...
| `OPT-UNPARSED` | advisory | `ds-troupe-2` | — |
| `OPT-UNPARSED` | advisory | `ds-troupe-2` | — |
| `OPT-UNPARSED` | advisory | `ds-tyranid-prime-with-lash-whip` | — |
| `OPT-UNPARSED` | advisory | `ds-tyranid-warriors-with-ranged-bio-weapons` | — |
| `OPT-UNPARSED` | advisory | `ds-tyrant-guard` | — |
| `OPT-UNPARSED` | advisory | `ds-tzaangor-enlightened` | — |
| `OPT-UNPARSED` | advisory | `ds-tzaangors` | — |
...
| `OPT-UNPARSED` | advisory | `ds-vanguard-veteran-squad-with-jump-packs-6` | — |
| `OPT-UNPARSED` | advisory | `ds-vanguard-veteran-squad-with-jump-packs-6` | — |
| `OPT-UNPARSED` | advisory | `ds-venatari-custodians` | — |
| `OPT-UNPARSED` | advisory | `ds-vertus-praetors` | — |
| `OPT-UNPARSED` | advisory | `ds-vespid-stingwings` | — |
| `OPT-UNPARSED` | advisory | `ds-veteran-bike-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-vigilant-squad` | — |
| `OPT-UNPARSED` | advisory | `ds-vypers` | — |
| `OPT-UNPARSED` | advisory | `ds-vypers` | — |
| `OPT-UNPARSED` | advisory | `ds-war-walkers` | — |
| `OPT-UNPARSED` | advisory | `ds-warbikers` | — |
| `OPT-UNPARSED` | advisory | `ds-warboss` | — |
| `OPT-UNPARSED` | advisory | `ds-warbuggies` | — |
| `OPT-UNPARSED` | advisory | `ds-warlock-conclave` | — |
| `OPT-UNPARSED` | advisory | `ds-warlock-skyrunners` | — |
| `OPT-UNPARSED` | advisory | `ds-warp-spiders` | — |
| `OPT-UNPARSED` | advisory | `ds-windriders` | — |
...
| `OPT-UNPARSED` | advisory | `ds-wraithlord` | — |
| `OPT-UNPARSED` | advisory | `ds-wulfen` | — |
| `OPT-UNPARSED` | advisory | `ds-wulfen-dreadnought` | — |
| `OPT-UNPARSED` | advisory | `ds-wulfen-with-storm-shields` | — |
| `OPT-UNPARSED` | advisory | `ds-wyches` | — |
...
<details><summary>reconciliation (3588)</summary>
...
| `REC-NEVER-PRICED` | blocking | `wahapedia:space-marines:Chaplain-Kastiel` | A chapter-specific named character datacard that prints no unit-cost table, and which the points source does not carry at all -- it also raises REC-UNMATCHED-DETAIL-ONLY, so no unmatched points entry exists that a rename could be argued from. No source prices it. Excluded rather than shipped at zero; the digest lapses the moment either source prices it. |
| `REC-NEVER-PRICED` | blocking | `wahapedia:space-marines:Judiciar-Xacharus` | A chapter-specific named character datacard that prints no unit-cost table, and which the points source does not carry at all -- it also raises REC-UNMATCHED-DETAIL-ONLY, so no unmatched points entry exists that a rename could be argued from. No source prices it. Excluded rather than shipped at zero; the digest lapses the moment either source prices it. |
| `REC-NEVER-PRICED` | blocking | `wahapedia:space-marines:Sanguinary-Priest-on-Bike` | A Legends datacard that prints no unit-cost table. Nothing else can price it: the points source prices no Legends datasheet at all this release, and this faction's page leaves no unmatched unit that a rename could be argued from. Excluded rather than shipped at zero; the digest lapses the moment either source prices it. |
| `REC-NEVER-PRICED` | blocking | `wahapedia:t-au-empire:Tactical-Drones` | A Legends datacard that prints no unit-cost table. Nothing else can price it: the points source prices no Legends datasheet at all this release, and this faction's page leaves no unmatched unit that a rename could be argued from. Excluded rather than shipped at zero; the digest lapses the moment either source prices it. |
| `REC-RENAME` | advisory | `ds-ancient-on-bike` | — |
| `REC-RENAME` | advisory | `ds-apothecary-on-bike` | — |
| `REC-RENAME` | advisory | `ds-assault-squad-with-jump-packs` | — |
| `REC-RENAME` | advisory | `ds-captain-on-bike` | — |
| `REC-RENAME` | advisory | `ds-librarian-on-bike` | — |
| `REC-RENAME` | advisory | `ds-librarian-with-jump-pack` | — |
| `REC-RENAME` | advisory | `ds-techmarine-on-bike` | — |
...
| `REC-UNMATCHED-DETAIL-ONLY` | advisory | `wahapedia:space-marines:Chaplain-Kastiel` | — |
...
| `REC-UNMATCHED-DETAIL-ONLY` | advisory | `wahapedia:space-marines:Judiciar-Xacharus` | — |
...
| `REC-UNMATCHED-DETAIL-ONLY` | advisory | `wahapedia:space-marines:Sanguinary-Priest-on-Bike` | — |
...
| `REC-UNMATCHED-DETAIL-ONLY` | advisory | `wahapedia:t-au-empire:Tactical-Drones` | — |
...
<details><summary>summary (1426)</summary>
...
| `GLS-OUTSTANDING` | advisory | `glossary:accursed cultists undivided shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:ancient deathwing` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:ancient ravenwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:apothecary ravenwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:attack bike squad ravenwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:ballistus dreadnought deathwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:be lakor shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:beasts of nurgle shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:bike squad ravenwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:bladeguard ancient deathwing` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:bladeguard veteran squad deathwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:bloodcrushers shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:bloodletters` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:bloodletters shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:bloodmaster shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:bloodthirster` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:bloodthirster shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:brimstone shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:brutalis dreadnought deathwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:burning chariot shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:caestus assault ram ravenwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:captain deathwing` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:captain ravenwing` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:carab culln the risen deathwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:changecaster shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:chaos lord in terminator armour undivided shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:chaos lord on bike` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:chaos lord undivided shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:chaos spawn` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:chaos terminator squad` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:chaos terminator squad undivided shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:chaplain deathwing` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:chaplain grimaldus` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:chaplain ravenwing` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:chaplain venerable dreadnought deathwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:chosen undivided shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:company champion ravenwing` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:company heroes` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:company veterans ravenwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:contorted epitome shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:cult demagogue undivided shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:cult mechanicus` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:cultist firebrand` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:cultist firebrand undivided shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:cultist mob` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:cultist mob undivided shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:cultist mob with firearms` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:cultist mob with firearms undivided shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:daemon prince of chaos shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:daemon prince of chaos with wings shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:daemon prince with wings` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:daemonettes` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:daemonettes shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:dark apostle undivided shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:deathwing command squad deathwing` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:deathwing knights` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:deathwing strikemaster deathwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:deredeo dreadnought deathwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:disc of tzeentch undivided shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:dreadnought deathwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:exalted flamer shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:fateskimmer shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:feculent gnarlmaw shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:fellblade` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:fellgor beastmen` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:fellgor beastmen undivided shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:fiends shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:fire raptor gunship ravenwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:flamers shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:flesh hounds shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:flesh shaper` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:fluxmaster shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:furies shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:gellerpox infected undivided shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:giant chaos spawn shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:great unclean one shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:havocs undivided shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:hellflayer shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:hellflayers shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:herald of slaanesh shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:infernal enrapturess shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:invader atv ravenwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:ironclad dreadnought deathwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:javelin attack speeder ravenwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:juggernaut undivided shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:keeper of secrets shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:land raider crusader deathwing` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:land raider deathwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:land raider redeemer deathwing` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:land speeder ravenwing` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:land speeder storm ravenwing` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:land speeder tempest ravenwing` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:land speeder tornado ravenwing` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:land speeder typhoon ravenwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:legionaries undivided shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:leviathan dreadnought deathwing` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:lhykhis` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:librarian` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:librarian deathwing` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:librarian dreadnought` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:librarian ravenwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:lord of change shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:master of possession undivided shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:mortis dreadnought deathwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:mutoid vermin undivided shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:negavolt cultists undivided shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:nurglings shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:outrider squad ravenwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:palanquin of nurgle undivided shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:plague drones shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:plague toads shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:plaguebearers` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:plaguebearers shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:possessed undivided shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:pox riders shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:poxbringer shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:raptors undivided shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:ravenwing talonmaster ravenwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:redemptor dreadnought deathwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:relic contemptor dreadnought deathwing` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:relic razorback` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:relic terminator squad deathwing` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:remora stealth drones` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:remote sensor tower` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:rendmaster on blood throne shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:renegade enforcer` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:renegade enforcer undivided shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:renegade heavy weapons squad` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:renegade heavy weapons squad undivided shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:renegade ogryn beast handler` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:renegade ogryn beast handler undivided shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:renegade ogryn brutes` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:renegade ogryn brutes undivided shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:renegade plague ogryns` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:renegade plague ogryns undivided shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:repulsor deathwing` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:repulsor executioner` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:repulsor executioner deathwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:rogue psyker undivided shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:scout bike squad ravenwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:screamers shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:seekers shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:skull altar shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:skull cannon shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:skullmaster shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:sloppity bilepiper shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:sly marbo` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:sokar pattern stormbird` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:sokar pattern stormbird ravenwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:sorcerer in terminator armour undivided shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:sorcerer on bike` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:sorcerer undivided shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:sororitas rhino` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:soul grinder shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:spined chaos beast shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:spiritseer` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:spoilpox scrivener shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:steed of slaanesh undivided shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:sternguard veteran squad` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:sternguard veteran squad deathwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:storm eagle gunship ravenwing` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:storm guardians` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:storm speeder hailstrike ravenwing` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:storm speeder hammerstrike ravenwing` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:storm speeder thunderstrike ravenwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:stormhawk interceptor ravenwing` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:stormlord` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:stormraven gunship` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:stormraven gunship ravenwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:stormtalon gunship ravenwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:techmarine ravenwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:terminator assault squad deathwing` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:terminator squad` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:terminator squad deathwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:thunderhawk gunship ravenwing` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:thunderhawk transporter ravenwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:tormentbringer shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:traitor enforcer undivided shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:traitor guardsmen squad` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:traitor guardsmen squad undivided shadow legion` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:trajann valoris` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:tranceweaver shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:vanguard invader burrower` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:vanguard veteran squad` | — |
| `GLS-OUTSTANDING` | advisory | `glossary:vanguard veteran squad with jump packs deathwing` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:warp talons undivided shadow legion` | — |
...
| `GLS-OUTSTANDING` | advisory | `glossary:xiphon interceptor ravenwing` | — |
