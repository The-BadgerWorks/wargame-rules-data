# Validation report — wh40k-11e-2026-08-2

**ADVISORY ONLY** — eligible for publication pending approval.

Run `local-wh40k-11e-2026-08-2` on the `prerelease` channel, 2026-08-12T00:00:00Z.
...
| keyword classification | 1371 | 1449 | 94.6% | 95.0% |
| loadout.default equipment | 2017 | 0 | 97.0% | 0.0% |
| loadout.options resolved | 1916 | 0 | 92.0% | 0.0% |
...
| wargear options | 1916 | 1676 | 114.3% | 90.0% |
...
0 blocking, 9016 advisory, 2 suppressed.

<details><summary>coverage (19)</summary>

| code | severity | entities | resolved |
|---|---|---|---|
| `COV-COLLAPSE` | blocking | `coverage:keyword_classification` | The count fell because a defect stopped inventing keywords (006 T049), not because any keyword stopped being classified. All 144 values dropped carry a printed separator and are composites no page prints; the 66 gained are the real keywords they hid, all classified. Distinct UNCLASSIFIED keywords -- what this check watches -- is 18 in both releases. |
...
<details><summary>reconciliation (7177)</summary>
